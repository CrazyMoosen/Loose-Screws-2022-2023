...
This repository contains the public FTC SDK for Loose Screws #22012 for the POWERPLAY (2022-2023) competition season!
...
This project contains all the OpModes and Autonomous modes for Loose Screws #22012 for the POWERPLAY Season
This project will be updated multiple times as we continue to change the robot and the corresponding code.

Samples Folder: &nbsp;&nbsp; [/FtcRobotController/src/main/java/org/firstinspires/ftc/robotcontroller/external/samples](FtcRobotController/src/main/java/org/firstinspires/ftc/robotcontroller/external/samples)

The readme.md file located in the [/TeamCode/src/main/java/org/firstinspires/ftc/teamcode](TeamCode/src/main/java/org/firstinspires/ftc/team22012) folder contains an explanation of the sample naming convention, and instructions on how to copy them to your own project space.
