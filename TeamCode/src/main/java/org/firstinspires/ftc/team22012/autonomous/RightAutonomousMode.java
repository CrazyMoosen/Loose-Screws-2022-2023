...
//                    parked=true;
//
//                    while (armEncoder.getRevolutions() > 0.1) {
//                        arm.moveDown();
//                    }
//                    arm.stop();
//                }
...
//        Mat img = new Mat(frame.getHeight(), frame.getWidth(), CvType.CV_8UC3);
...
//
//        Imgcodecs.imwrite("sdcard/FIRST/purpThresh.png", thresholdedForPurple);
//
//        Mat thresholdedForYellow = new Mat();
//        Core.inRange(ROIHsv, yellow_lower, yellow_upper, thresholdedForYellow);
//
//        Imgcodecs.imwrite("sdcard/FIRST/yellowThresh.png", thresholdedForYellow);
//
//        Mat thresholdedForGreen = new Mat();
//        Core.inRange(ROIHsv, green_lower, green_upper, thresholdedForGreen);
//
//        Imgcodecs.imwrite("sdcard/FIRST/greenThresh.png", thresholdedForGreen);
//
//
